...
from loss_variability_due_to_data import model_risks
...
for j in range(50):
    ...
    toy_dataset1 = toy_data(50, seed=1002 + 2 * j)
    toy_dataset2 = toy_data(50, seed=1002 + 2 * j + 1)
    ...
    h_1 = LogisticRegression().fit(X1, y1)
    ...
    h_2 = LogisticRegression().fit(X2, y2)
